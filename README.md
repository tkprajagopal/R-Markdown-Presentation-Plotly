...
## This is a repo with the gh-pages branch. The HTML page can be viewed online by clicking [on this Github Pages link.](https://github.com/tkprajagopal/R-Markdown-Presentation-Plotly-/blob/master/Plotly.html)
